...
import VirtualDesignerModal from './VirtualDesignerModal.tsx';
import AccessoriesSection from './AccessoriesSection.tsx';
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-8">
                    ...
                    <div>
                        <div className="mb-4 aspect-square bg-gray-100 rounded-lg overflow-hidden">
                            <img src={mainImage} alt={product.name[language]} className="w-full h-full object-contain" />
                        </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-center gap-2">
                             ...
                             <button onClick={handleListenDescription} disabled={isSpeaking} className="p-2 bg-gray-100 rounded-full hover:bg-gray-200 disabled:opacity-50">
